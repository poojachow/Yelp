...
class YelpClient: BDBOAuth1RequestOperationManager {
    ...
    func searchWithTerm(_ latitude: Double, longitude: Double, term: String?, sort: YelpSortMode?, categories: [String]?, deals: Bool?, distance: Double?, offset: Int?, completion: @escaping ([Business]?, Error?) -> Void) -> AFHTTPRequestOperation {
        // For additional parameters, see http://www.yelp.com/developers/documentation/v2/search_api
